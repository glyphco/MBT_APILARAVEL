...
class CreateShowtemplateProducersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('showtemplate_producers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('showtemplate_producers');
    }
